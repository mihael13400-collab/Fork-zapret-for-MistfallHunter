...
Если вы не доверяете бинарным файлам из этого репозитория, вы можете сверить контрольные суммы файлов WinDivert.dll и winws.exe с оригинальной сборкой из официального репозитория zapret:
