...
--filter-udp=20001-21000 --ipset="%LISTS%ipset-all-as16509-amazon.txt" --dpi-desync=fake --dpi-desync-ttl=11 --dpi-desync-repeats=12 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_dbankcloud_ru.bin" --dpi-desync-cutoff=n4 --new ^
