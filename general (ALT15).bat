...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,%GameFilterTCP% --wf-udp=443,19294-19344,20001-49999,50000-50100,%GameFilterUDP% ^
...
--filter-tcp=12001 --dpi-desync=fake,multisplit --dpi-desync-any-protocol=1 --dpi-desync-fooling=ts --dpi-desync-split-pos=1 --dpi-desync-repeats=12 --dpi-desync-fake-unknown="%BIN%stun.bin" --dpi-desync-fake-unknown="%BIN%tls_clienthello_max_ru.bin" --new ^
--filter-udp=20001-49999 --ipset="%LISTS%ipset-all-as16509-amazon.txt" --dpi-desync=fake --dpi-desync-ttl=11 --dpi-desync-repeats=12 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_dbankcloud_ru.bin" --dpi-desync-cutoff=n4 --new ^
